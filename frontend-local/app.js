// Configuration
const API_BASE_URL = 'http://localhost:29000'; // Change this to match your API server
...
function displayResults(data) {
    ...
    if (data.results.length > 0) {
        ...
        const existingAiInfoElements = document.querySelectorAll('.ai-ranking-info');
        ...
        sortedResults.forEach((place, index) => {
            ...
            // Format hierarchy
            const hierarchy = place.hierarchy && place.hierarchy.length > 0 
